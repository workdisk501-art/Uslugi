...
const trustFeatures = [
  { icon: ShieldCheck,    title: 'Понимаю ваш бизнес',        sub: 'Погружаемся в процессы и задачи компании' },
  { icon: Settings,       title: 'Строю систему под задачи',   sub: 'Настраиваем учёт под ваши цели и процессы' },
  { icon: TrendingUp,     title: 'Сопровождаю рост компании',  sub: 'Система масштабируется вместе с бизнесом' },
  { icon: HeadphonesIcon, title: 'Всегда на связи и рядом',     sub: 'Оперативно помогаем и отвечаем на вопросы' },
];
    ...
    <section style={{ background: '#0F172A', padding: '112px 0 96px' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 56px' }}>
        ...
        <FadeUp delay={0.1} className="hidden md:block">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: 20, marginBottom: 64 }}>
          ...
          >
            ...
            <div>
              ...
              <FadeUp delay={0.1}>
                ...
                >
                  Помогаю собственникам выстроить систему управленческого учёта, которая отвечает на вопросы бизнеса, а не просто собирает цифры.
                </p>
              </FadeUp>
